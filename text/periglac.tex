...
\begin{boxotazky}{Kontrolní a klíčové otázky, na které bychom měli znát odpověď}
	\begin{itemize}
		\item Co je to permafrost a jak je definován?
		\item Co je to aktivní vrstva? Čím je charakteristická?
		\item K čemu může docházet v důsledku zamrzání a tání vody?
		\item Co je to degradace permafrostu? Jaké tvary reliéfu s tím souvisejí?
		
	\end{itemize}
\end{boxotazky}

\begin{boxslovnik}{Další klíčové pojmy k zapamatování}
	epigenetický a syngenetický permafrost & aktivní vrstva \\
	talik & půdní led \\
